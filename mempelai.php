    ...
    <div class="box">
        ...
        <div class="frame-mempelai">
            ...
            <div class="box-content">
                ...
                <div class="assalamualaikum"><i>Assalamualaikum warahmatullahi wabarakatuh</i></div>
                <div class="mahasuci">
                    <p style="font-size: 12px;">Maha suci Allah, yang telah menciptakan makhluknya-Nya berpasang-pasangan. Ya Allah, perkenankanlah kami menikahkan putra putri kami :</p>
                </div>
                <div>
                    <span class="putri">Nurul Azizah S.Pd</span>
                    <img src="image/line2.png" alt="line2" class="lineputri">
                </div>
                <div class="anak-wanita">
                    <p class="font-putri">Putri Pertama</p>
                    <p>Bapak Rusdi</p>
                    <p>Ibu Samih</p>
                </div>
                <div>
                ...
                <div>
                    <span class="putra">Abdul Rojak</span>
                    <img src="image/line2.png" alt="line2" class="line-putra">
                </div>
                <div class="anak-laki">
                    <p class="font-putra">Putra Bungsu</p>
                    <p>Bapak KH. Mualim Syuaib (Alm)</p>
                    <p>Ibu Junariah (Almh)</p>
                </div>
            </div>
        </div>
