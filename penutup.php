...
<body>
        ...
        <div class="frame-mempelai">
            ...
            <div class="box-content">
                <div class="penutup">
                    ...
                    <i style="font-size: 11px;">Wassalamu'alaikum Warahmatullahi Wabarakatuh</i>
                    <p style="margin-top: 20px;">
                        Turut berbahagia,
                        <br>Segenap keluarga besar
                    </p>
                </div>
                <div class="teks">
                    <span>Dede & Sandi</span>
                </div>
                <div class="watermark">
                    <p style="font-size: 10px; margin-top: 25px;">Website Invitation by <br> <span style="font-size: 14px; color: goldenrod;">RADEN HUDA</span></p>
                </div>
    ...
    <!-- <nav class="navbar navbar-dark bg-info navbar-expand fixed-bottom d-md-none d-lg-none d-xl-none">
        <ul class="navbar-nav nav-justified w-100">
            ...
            <li class="nav-item">
                <a href="sampul.php" class="nav-link">
                    <div class="icon">
                        <i class="fa fa-address-book" aria-hidden="true"></i>
                    </div>
                    <div class="name" data-text="Sampul">Sampul</div>
            ...
            <li class="nav-item">
                <a href="mempelai.php" class="nav-link">
                    <div class="icon">
                        <i class="fa fa-heart" aria-hidden="true"></i>
                    </div>
                    <div class="name" data-text="Mempelai">Mempelai</div>
            ...
            <li class="nav-item">
                <a href="protokol.php" class="nav-link">
                    <div class="icon">
                        <i class="fa fa-book" aria-hidden="true"></i>
                    </div>
                    <div class="name" data-text="Protokol">Protokol</div>
            ...
            <li class="nav-item">
                <a href="penutup.php" class="nav-link">
                    <div class="icon">
                        <i class="fa fa-certificate" aria-hidden="true"></i>
                    </div>
                    <div class="name" data-text="Penutup">Penutup</div>
