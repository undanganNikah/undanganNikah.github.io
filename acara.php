    ...
    <div class="box">
        ...
        <div class="frame-mempelai">
            ...
            <div class="box-content">
                <div class="acara">Rangkaian Acara</div>
                <div class="akad">
                    <tr>
                        <td><img src="image/line_b19973.jpg" alt="line" class="grkiri"></td>
                        <td>Akad Nikah</td>
                        <td><img src="image/line_b19973.jpg" alt="line" class="grkanan"></td>
                    </tr>
                </div>
                <div class="tglakad">
                    <span class="hariakad">Minggu</span>
                    <span class="jamakad">08.00 WIB</span>
                    <span class="bulanakad">Juni</span>
                    <span class="tahunakad">2021</span>
                    <div class="boxtgl1">06</div>
                    <p>Kediaman Mempelai Wanita</p>
                </div>
                <div class="resepsi">
                    <tr>
                        <td><img src="image/line_b19973.jpg" alt="" class="garisR"></td>
                        <td>Resepsi</td>
                        <td><img src="image/line_b19973.jpg" alt="" class="garisR"></td>
                    </tr>
                </div>
                <div class="tglresepsi">
                    <span class="hariresepsi">Minggu</span>
                    <span class="jamresepsi">09.00 WIB ~ Selesai</span>
                    <span class="bulanresepsi">Juni</span>
                    <span class="tahunresepsi">2021</span>
                    <div class="boxtgl2">06</div>
                    <p>Kediaman Mempelai Wanita</p>
                </div>
                <div class="alamatresepsi">
                    <p style="font-size: 12px; margin-top: -22px; line-height: 13px;">Jl. Halim Perdana Kusuma Gg. Kumpi Jisin RT. 001/03 Kel. Jurumudi Baru Kec. Benda Kota Tangerang, Banten</p>
                </div>
